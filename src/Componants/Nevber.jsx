        ...
        <div className="container mx-auto">
          <div className="navbar text-black shadow-sm">
            <div className="navbar-start">
              <div className="dropdown">
                <div
                  tabIndex={0}
                  role="button"
                  className="btn btn-ghost lg:hidden bg-black text-white hover:bg-gray-800"
                >
                  <svg
                    aria-label="Menu"
                ...
                >
                  <li>
                    <a className={menuClass}>Home</a>
                  </li>
                  <li>
                    <a className={menuClass}>Technologies</a>
                  </li>
                  <li>
                    <a className={menuClass}>Projects</a>
                  </li>
                  <li>
                    <a className={menuClass}>About</a>
                  </li>
                  <li>
                    <a className={menuClass}>Contact</a>
                  </li>
                </ul>
              </div>
            ...
            <div className="navbar-end gap-2">
              <button className="btn btn-soft border-none bg-white text-black">
                Sign In
              </button>
